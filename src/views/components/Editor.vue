    ...
    mounted() {
      ...
      const setting =
      {
        ...
        *                         { padding:0; margin:0; }
        ...
        'toolbar1': 'table |insertfile undo redo | formatselect | link unlink | uploadimg image media | numlist bullist | visualblocks', // 工具栏1
        'toolbar2': ' fontsizeselect | forecolor backcolor | fontselect bold italic underline strikethrough | alignleft aligncenter alignright alignjustify | outdent indent | removeformat | link imageSelector | ltr rtl | fullscreen | emoticons | insertdatetime | help', // 工具栏2
        file_picker_callback: function(callback, value, meta) {

          var inputFiles = document.getElementById('my-file');
          inputFiles.click();
          inputFiles.onchange = (e) =>{
            ...
            if(files.length > 0){
              ...
              if (meta.filetype == 'image') {
                ...
                //callback('http://localhost:3001/static/img/123.png', {alt: file.name});
        ...
        images_upload_handler: function(blobInfo, success, failure) {
          ...
          function uploadPic() { // 发送请求
            ...
            xhr.onload = function() {
              ...
              console.log(xhr.responseText.files);
